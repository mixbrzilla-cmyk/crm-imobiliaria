...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9]">
      <aside className="fixed left-0 top-0 h-screen w-72 border-r border-white/10 bg-[#0b2533] px-6 py-7 text-slate-100">
        <div className="mb-10">
        ...
        <nav className="flex flex-col gap-1">
          <Link
            href="/admin"
            className="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-100/90 transition-all duration-300 hover:bg-white/10 hover:text-white"
          >
